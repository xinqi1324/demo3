...
import com.example.demo3.utils.FileLock;
...
public class WebUploader {
    ...
    public String md5Check(String key) {
        ...
        if (!StringUtils.isEmpty(md5)) {
            map = gson.fromJson(md5, new TypeToken<HashMap<String, String>>() {
            }.getType());
    ...
    public boolean saveMd52FileMap(String key, String file) {
        ...
        stringRedisTemplate.opsForValue().set("md5", gson.toJson(map));
        return true;
    }
